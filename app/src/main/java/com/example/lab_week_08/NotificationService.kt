...
import android.os.Looper // <- IMPORT BARU DITAMBAHKAN
...
class NotificationService : Service() {
    ...
    private fun getNotificationBuilder(
        ...
        NotificationCompat.Builder(this, channelId)
            ...
            .setTicker("Second worker process is dia done, check it out!")
    ...
    // ===================================================================
    // == KODE BARU YANG ANDA BERIKAN DIMULAI DI SINI ==
    // ===================================================================
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        serviceHandler.post {
            ...
            // == PERBAIKAN DI SINI ==
            // ==============================================================
            // Baris ini dijadikan komentar agar notifikasi
            // tidak langsung hilang setelah hitungan mundur selesai.
            // Anda sekarang bisa melihat notifikasi di shade
            // bahkan setelah toast-nya muncul.
            //
